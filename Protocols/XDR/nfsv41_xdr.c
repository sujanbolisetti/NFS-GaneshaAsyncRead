...
bool_t
xdr_ASYNC_READ4args (XDR *xdrs, ASYNC_READ4args *objp)
{
	register int32_t *buf;

	 if (!xdr_uint64_t (xdrs, &objp->reqId))
		 return FALSE;
	 if (!xdr_stateid4 (xdrs, &objp->stateid))
		 return FALSE;
	 if (!xdr_offset4 (xdrs, &objp->offset))
...
bool_t
xdr_ASYNC_READ4res (XDR *xdrs, ASYNC_READ4res *objp)
{
	register int32_t *buf;
...
xdr_nfs_resop4 (XDR *xdrs, nfs_resop4 *objp)
{
	...
	case OP_RECLAIM_COMPLETE:
		...
		break;
	case OP_ASYNC_READ:
		 if (!xdr_ASYNC_READ4res (xdrs, &objp->nfs_resop4_u.opasync_read))
			 return FALSE;
		break;
	case OP_ILLEGAL:
...
bool_t
xdr_CB_ASYNC_READ4argsok (XDR *xdrs, CB_ASYNC_READ4argsok *objp)
{
	register int32_t *buf;
...
bool_t
xdr_CB_ASYNC_READ4res (XDR *xdrs, CB_ASYNC_READ4res *objp)
{
	register int32_t *buf;
...
bool_t
xdr_CB_ASYNC_READ4args (XDR *xdrs, CB_ASYNC_READ4args *objp)
{
	register int32_t *buf;
	...
	switch (objp->status) {
	case NFS4_OK:
		 if (!xdr_CB_ASYNC_READ4argsok (xdrs, &objp->CB_ASYNC_READ4args_u.argok4))
			 return FALSE;
		break;
	default:
		break;
...
xdr_nfs_cb_argop4 (XDR *xdrs, nfs_cb_argop4 *objp)
{
	...
	case OP_CB_ASYNC_READ:
		 if (!xdr_CB_ASYNC_READ4args (xdrs, &objp->nfs_cb_argop4_u.opcbasync_read))
			 return FALSE;
		break;
	case OP_CB_ILLEGAL:
		break;
...
xdr_nfs_cb_resop4 (XDR *xdrs, nfs_cb_resop4 *objp)
{
	...
	case OP_CB_NOTIFY_DEVICEID:
		...
		break;
	case OP_CB_ASYNC_READ:
		 if (!xdr_CB_ASYNC_READ4args (xdrs, &objp->nfs_cb_resop4_u.opcbasync_read))
			 return FALSE;
		break;
	case OP_CB_ILLEGAL:

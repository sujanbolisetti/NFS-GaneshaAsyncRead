...
typedef struct ASYNC_READ4res ASYNC_READ4res;
...
typedef struct CB_ASYNC_READ4argsok CB_ASYNC_READ4argsok;

struct CB_ASYNC_READ4res {
	nfsstat4	status;
};
typedef struct CB_ASYNC_READ4res CB_ASYNC_READ4res;

struct CB_ASYNC_READ4args {
	nfsstat4 status;
	union {
		CB_ASYNC_READ4argsok argok4;
	} CB_ASYNC_READ4args_u;
};

typedef struct CB_ASYNC_READ4args CB_ASYNC_READ4args;
  ...
  static inline bool xdr_layouthint4(XDR * xdrs, layouthint4 *objp)
{
  ...
  static inline bool xdr_ASYNC_READ4res(XDR * xdrs, ASYNC_READ4res *objp)
  {
	  if (!xdr_nfsstat4(xdrs, &objp->status))
		  return false;
	  return true;
  ...
  static inline bool xdr_ASYNC_READ4args(XDR * xdrs, ASYNC_READ4args *objp)
  {
	  if (!inline_xdr_u_int64_t(xdrs, &objp->reqid))
	  		return false;
	  if (!xdr_stateid4(xdrs, &objp->stateid))
		  return false;
	  if (!xdr_offset4(xdrs, &objp->offset))
  ...
  static inline bool xdr_nfs_argop4(XDR * xdrs, nfs_argop4 *objp)
  {
	  ...
	  case NFS4_OP_ASYNC_READ:
		  if (!xdr_ASYNC_READ4args(xdrs, &objp->nfs_argop4_u.opasync_read))
			  return false;
		  break;
  ...
  static inline bool xdr_nfs_resop4(XDR * xdrs, nfs_resop4 *objp)
  {
	  ...
	  case NFS4_OP_ASYNC_READ:
		  if (!xdr_ASYNC_READ4res
				  (xdrs, &objp->nfs_resop4_u.opasync_read))
			  return false;
		  break;
		  /* NFSv4.2 */
	  case NFS4_OP_WRITE_PLUS:
  ...
  static inline bool xdr_CB_ASYNC_READ4argsok(XDR * xdrs,
  		  	  CB_ASYNC_READ4argsok *objp)
    {
	  if (!inline_xdr_u_int64_t(xdrs, &objp->reqid))
	  	  		return false;
   ...
   static inline bool xdr_CB_ASYNC_READ4args(XDR * xdrs,
		   CB_ASYNC_READ4args *objp)
   {
 	  if (!xdr_nfsstat4(xdrs, &objp->status))
 		  return false;
 	  switch (objp->status) {
 	  case NFS4_OK:
 		  if (!xdr_CB_ASYNC_READ4argsok
 				  (xdrs, &objp->CB_ASYNC_READ4args_u.argok4))
 			  return false;
 		  break;
 	  default:
 		  break;
  ...
  static inline bool xdr_CB_ASYNC_READ4res(XDR * xdrs,
		  CB_ASYNC_READ4res *
		  objp)
  {
	  if (!xdr_nfsstat4(xdrs, &objp->status))
  ...
  static inline bool xdr_nfs_cb_argop4(XDR * xdrs, nfs_cb_argop4 *objp)
  {
	  ...
	  case NFS4_OP_CB_NOTIFY_DEVICEID:
		  if (!xdr_CB_NOTIFY_DEVICEID4args
			  ...
			  return false;
		  break;
	  case NFS4_OP_CB_ASYNC_READ:
		  if (!xdr_CB_ASYNC_READ4args
				  (xdrs, &objp->nfs_cb_argop4_u.opcbasync_read))
			  return false;
		  break;
  ...
  static inline bool xdr_nfs_cb_resop4(XDR * xdrs, nfs_cb_resop4 *objp)
  {
	  ...
	  case NFS4_OP_CB_NOTIFY_DEVICEID:
		  ...
		  break;
	  case NFS4_OP_CB_ASYNC_READ:
	  		  if (!xdr_CB_ASYNC_READ4res
	  				  (xdrs, &objp->nfs_cb_resop4_u.opcbasync_read))
	  			  return false;
	  		  break;
	  case NFS4_OP_CB_ILLEGAL:
  ...
  static inline bool xdr_ASYNC_READ4args (XDR *, ASYNC_READ4args*);
  static inline bool xdr_ASYNC_READ4res (XDR *, ASYNC_READ4res*);
  ...
  static inline bool xdr_CB_ASYNC_READ4args(XDR *,CB_ASYNC_READ4args *);
  static inline bool xdr_CB_ASYNC_READ4argsok(XDR*,CB_ASYNC_READ4argsok *);
  static inline bool xdr_CB_ASYNC_READ4res(XDR *,CB_ASYNC_READ4res *);
...
static inline bool xdr_ASYNC_READ4args ();
static inline bool xdr_ASYNC_READ4res ();
...
static inline bool xdr_CB_ASYNC_READ4argsok ();
static inline bool xdr_CB_ASYNC_READ4res ();
static inline bool xdr_CB_ASYNC_READ4args ();
